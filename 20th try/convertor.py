...
for line in text.split(u'\n'):    
    ...
    for item in column: # Changing items in Columns
        count+=1
        if count==3:
            if column[0].strip() in u"~#@“'\/<>()[]}{.,?!$*+-_&0123456789،؛؟٠١٢٣٤٥٦٧٨٩«»،؛۱۲۳۴۵۶۷۸۹۰﷼":#Common charcters
        ...
        if count==5:
            if column[0].strip() in u"0123456789":# English numbers
                ...
                new_line+=u'4 '
            elif column[0].strip() in u"٠١٢٣٤٥٦٧٨٩۱۲۳۴۵۶۷۸۹۰":# Your language's numbers and its alternatives
                new_line+=u'5 '
